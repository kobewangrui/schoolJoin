...
<template>
    <div class="outer">
        <ul class="menu">
            <li @click="filterListData(5)" :class="{'active':smallType===5}">
                <p class="icon">
                    <img :src="require('assets/image/earth.png')">
                </p>
                <p>大绳之翼</p>
            </li>
            <li @click="filterListData(6)" :class="{'active':smallType===6}">
                <p class="icon">
                    <img :src="require('assets/image/athletics.png')">
                </p>
                <p>国际竞技</p>
            </li>
            <li @click="filterListData(7)" :class="{'active':smallType===7}">
                <p class="icon">
                    <img :src="require('assets/image/classroom.png')">
                </p>
                <p>美式课堂</p>
            </li>
            <li @click="filterListData(11)" :class="{'active':smallType===11}">
                <p class="icon">
